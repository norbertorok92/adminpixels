...
const PageHeader = lazy(() => import('components/utility/pageHeader'));
const Box = lazy(() => import('components/utility/box'));
const LayoutWrapper = lazy(() =>
  import('components/utility/layoutWrapper')
);
const ContentHolder = lazy(() =>
  import('components/utility/contentHolder')
);
