...
import { ChatViewWrapper } from 'containers/Chat/Messages.styles';

import { withAuthSync } from 'authentication/auth.utils';
import DashboardLayout from 'containers/DashboardLayout/DashboardLayout';
const DesktopView = dynamic(() => import('containers/Chat/DesktopView'));
const MobileView = dynamic(() => import('containers/Chat/MobileView'));
