...
import * as configs from 'containers/Charts/ReactVis/config';
...
const LineSeries = dynamic(() =>
  import('containers/Charts/ReactVis/Charts/LineSeries')
);
const LineMark = dynamic(() =>
  import('containers/Charts/ReactVis/Charts/LineMark')
);
const AreaChartElevated = dynamic(() =>
  import('containers/Charts/ReactVis/Charts/AreaChartElevated')
);
const StackedHorizontalBarChart = dynamic(() =>
  import('containers/Charts/ReactVis/Charts/StackedHorizontalBarChart')
);
const ClusteredStackedBarChart = dynamic(() =>
  import('containers/Charts/ReactVis/Charts/ClusteredStackedBarChart')
);
const CustomScales = dynamic(() =>
  import('containers/Charts/ReactVis/Charts/CustomScales')
);
const CircularGridLines = dynamic(() =>
  import('containers/Charts/ReactVis/Charts/CircularGridLines')
);
const DynamicProgrammaticRightedgehints = dynamic(() =>
  import(
    'containers/Charts/ReactVis/Charts/DynamicProgrammaticRightedgehints'
  )
);
const DynamicCrosshairScatterplot = dynamic(() =>
  import('containers/Charts/ReactVis/Charts/DynamicCrosshairScatterplot')
);
const SimpleRadialChart = dynamic(() =>
  import('containers/Charts/ReactVis/Charts/SimpleRadialChart')
);
const SimpleDonutChart = dynamic(() =>
  import('containers/Charts/ReactVis/Charts/SimpleDonutChart')
);
const CustomRadius = dynamic(() =>
  import('containers/Charts/ReactVis/Charts/CustomRadius')
);
const SimpleTreeMap = dynamic(() =>
  import('containers/Charts/ReactVis/Charts/SimpleTreeMap')
);
const DynamicTreeMap = dynamic(() =>
  import('containers/Charts/ReactVis/Charts/DynamicTreeMap')
);
const BasicSunburst = dynamic(() =>
  import('containers/Charts/ReactVis/Charts/BasicSunburst')
);
const AnimatedSunburst = dynamic(() =>
  import('containers/Charts/ReactVis/Charts/AnimatedSunburst')
);
const CandleStick = dynamic(() =>
  import('containers/Charts/ReactVis/Charts/CandleStick')
);
const ComplexChart = dynamic(() =>
  import('containers/Charts/ReactVis/Charts/ComplexChart')
);
const StreamGraph = dynamic(() =>
  import('containers/Charts/ReactVis/Charts/StreamGraph')
);
