...
const DesktopView = dynamic(() => import('containers/Mail/DesktopView'));
const MobileView = dynamic(() => import('containers/Mail/MobileView'));
const TabView = dynamic(() => import('containers/Mail/TabView'));
